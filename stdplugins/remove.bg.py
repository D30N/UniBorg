...
async def _(event):
    ...
    if "image" in contentType:
        with io.BytesIO(output_file_name.content) as remove_bg_image:
            remove_bg_image.name = "BGRemoved.png"
        ...
        await event.edit("Background Removed in {} seconds using RemoveBG API, \npowered by UniBorg".format(ms))
    else:
        await event.edit("RemoveBG API returned Errors. Please report to UniBorg\n`{}".format(output_file_name.content.decode("UTF-8")))
