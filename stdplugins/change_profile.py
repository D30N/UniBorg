...
.cbio <Bio> to change Bio
.cname <Name> to change Name 
.cpic <in reply> to change profile Pic"""
import os
...
async def _(event):
    ...
    try:
        ...
        await event.edit("✅ Successfully changed my profile Name!")
    except Exception as e:  # pylint:disable=C0103,W0703
        await event.edit(str(e))
...
async def _(event):
    ...
    await event.edit("Downloading picture to my local...")
    ...
    try:
        ...
        if photo:
            ...
            try:
                ...
                await event.edit("✅ Successfully changed my profile Pic!")
    try:
        os.remove(photo)
    except Exception as e:  # pylint:disable=C0103,W0703
